package com.atm.intellimate.core.config;
...
/**
 * Top-level configuration bound to the "intellimate" prefix in application.yml.
 */
@ConfigurationProperties(prefix = "intellimate")
public class IntelliMateProperties {
    ...
    public static class Agent {
        private String name = "intellimate";
