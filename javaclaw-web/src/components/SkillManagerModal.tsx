...
import { X, Plus, Pencil, Trash2, Loader2, FileText, Terminal, BookOpen, Download, Upload, ChevronDown } from "lucide-react";
import {
...
export default function SkillManagerModal({ open, onClose }: SkillManagerModalProps) {
